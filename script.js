...
const lessons = [
"<strong>Montée (Mount, Tate Shiho Gatame)</strong>: La position de mount (ou montée) en JJB est une position dominante où un combattant est assis sur le torse de son adversaire, contrôlant efficacement ses mouvements. Cette position permet d’appliquer des étranglements ou des clés articulaires tout en limitant les possibilités d’évasion de l’adversaire.",

"<strong>Garde fermée (Closed guard)</strong>: La garde fermée est une position où le pratiquant en bas entoure la taille de son adversaire avec ses jambes croisées, permettant de le contrôler et de préparer des attaques efficaces. C’est la première garde apprise en JJB, offrant à la fois défense et nombreuses options offensives.",
  
"<strong>La kimura (Ude Garami):</strong> C'est une clé d'épaule en jiu-jitsu brésilien qui consiste à saisir le poignet de l'adversaire et à plier son bras derrière son dos, exerçant une torsion douloureuse pour forcer la soumission. Cette technique polyvalente, souvent apprise depuis la garde fermée, a été popularisée par le judoka Masahiko Kimura lors d'un combat légendaire contre Helio Gracie.",
...
lessonElement.innerHTML = lessons[currentIndex];
